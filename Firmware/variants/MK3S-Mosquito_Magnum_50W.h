...
#define NOZZLE_TYPE "Mosquito_Magnum_50W"

// Printer name
#define CUSTOM_MENDEL_NAME "Prusa i3 MK3S-MM"
...
#define DEFAULT_MAX_FEEDRATE                {3000, 3000, 800, 120}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 120}      // (mm/sec)   max feedrate (M203), silent mode

#define DEFAULT_MAX_ACCELERATION            {1750, 1750, 200, 5000}  // (mm/sec^2) max acceleration (M201)
...
#define DEFAULT_TRAVEL_ACCELERATION   1750   // X, Y, Z and E max acceleration in mm/s^2 for travels (M204T)
...
#define NORMAL_MAX_FEEDRATE_XY   4242  // max feedrate in mm/s
...
#else
// Define PID constants for Mosquito Magnum 50W
...
#include "thermal_model/Mosquito_Magnum_50W.h"
#define THERMAL_MODEL_DEFAULT Mosquito_Magnum_50W // Default model parameters
